  ...
  return (
    <section className="porfolio">
      ...
      <ul className="porfolio__list">
        <li>
          <Link
            to="https://dashakvylina.github.io/russian-travel"
            target="_blank"
        ...
        <li>
          <Link
            to="https://github.com/dashakvylina/react-mesto-api-full"
            target="_blank"
            className="portfolio__about"
          >
        ...
        <li>
          <Link
            to="https://github.com/dashakvylina/movies-explorer-frontend"
            target="_blank"
            className="portfolio__about"
          >
